...
exports.parseReceviedData = function (req, cb) {
    var body = '';
...
exports.add = function(db, req, res){
    exports.parseReceviedData(req, function(work){
...
exports.delete = function(db, req, res){
    exports.parseReceviedData(req, function(work){
        db.qurey("DELETE FROM work WHERE id=?", [work.id],
        function(err){
            if(err) throw err;
            exprots.show(db, res);
        });
...
exports.archive = function(db, req, res){
    exports.parseReceviedData(req, function(work){
        db.qurey("UPDATE work SET archived = 1 WHERE id = ? ", [work.id],
        function(err){
            if(err) throw err;
            exprots.show(db, res);
        });
